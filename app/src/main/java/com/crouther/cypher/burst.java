...
public class burst extends Activity
    ...
    ///Activity Variables
    //Widgets
    public ImageView card2, card3, card4, temp, record, start, stop, listen, newRecording, stopMusic;
    public MediaRecorder myAudioRecorder;
    public MediaPlayer mediaPlayer, mp;
    public GestureDetector gestureDetector;
    public TextView optionHeader, songInfo;
    public TextView line2, line3, line4, lineTemp;
    ...
    double defaultCordinates[][] = new double[3][2];
    double lineCoordinates[][] = new double[3][2];
    ...
    public void resetCards(){
        ...
        line2.setTranslationX((float) lineCoordinates[0][0]);
        line2.setTranslationY((float) lineCoordinates[0][1]);
        line3.setTranslationX((float) lineCoordinates[1][0]);
        line3.setTranslationY((float) lineCoordinates[1][1]);
        line4.setTranslationX((float) lineCoordinates[2][0]);
        line4.setTranslationY((float) lineCoordinates[2][1]);

        card2.setTranslationX((float) defaultCordinates[0][0]);
        card2.setTranslationY((float) defaultCordinates[0][1]);
        card3.setTranslationX((float) defaultCordinates[1][0]);
        card3.setTranslationY((float) defaultCordinates[1][1]);
        card4.setTranslationX((float) defaultCordinates[2][0]);
        card4.setTranslationY((float) defaultCordinates[2][1]);
    }
                ...
                new TimerTask(){
                    ...
                    public void run(){
                        ...
                        if (current == 4) {
                            ...
                            temp = card2;
                            lineTemp = line2;
                            burst.this.runOnUiThread(new Runnable() {
                                public void run() {
                                    // update UI here
                                    resetCards();
                                }
